...
public class QuestionInputNumberConfiguration : IEntityTypeConfiguration<QuestionInputNumber>
{
    public void Configure(EntityTypeBuilder<QuestionInputNumber> builder)
    {
        builder.ToTable("questions_input_number");
