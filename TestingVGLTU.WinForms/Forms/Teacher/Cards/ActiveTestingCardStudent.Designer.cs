...
{
    partial class ActiveTestingCardStudent
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            labelAttempts.Size = new Size(100, 21);
            labelAttempts.TabIndex = 3;
            labelAttempts.Text = "Попытки: 1/2";
            // 
            // labelTimeTesting
            // 
            ...
            labelTimeTesting.Size = new Size(199, 21);
            labelTimeTesting.TabIndex = 2;
            labelTimeTesting.Text = "Осталось времени: 45 мин";
            // 
            // labelTeacherName
            // 
            ...
            buttonGoOver.Location = new Point(201, 0);
            buttonGoOver.Name = "buttonGoOver";
            buttonGoOver.Size = new Size(191, 45);
            buttonGoOver.TabIndex = 0;
            buttonGoOver.Text = "Продолжить";
            buttonGoOver.UseVisualStyleBackColor = false;
            // 
            // ActiveTestingCardStudent
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            Controls.Add(panelCard);
            Name = "ActiveTestingCardStudent";
